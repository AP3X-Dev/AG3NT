...
class MoveResult:
    ...
    Attributes:
        error: Error message on failure, None on success.
        source: Original path of the file/directory.
        destination: New path of the file/directory.
    """
...
@dataclass
class CopyResult:
    """Result from backend copy operations.
...
@dataclass
class MkdirResult:
    """Result from backend mkdir operations.
...
@dataclass
class AnalyzeFileResult:
    """Result from file analysis operations.

    Attributes:
        error: Error message on failure, None on success.
        path: Path of the analyzed file.
        analysis: The AI-generated analysis text.
        file_type: The detected file type (e.g., "image/png", "application/pdf").
...
class BackendProtocol(abc.ABC):
    ...
    def move(self, source: str, destination: str) -> MoveResult:
        ...
        Args:
            source: Absolute path of the file/directory to move.
            destination: Absolute path of the new location.

        Returns:
            MoveResult with source and destination paths on success, error on failure.
        """
        raise NotImplementedError("move not implemented for this backend")

    async def amove(self, source: str, destination: str) -> MoveResult:
    ...
    def copy(self, source: str, destination: str) -> CopyResult:
        ...
        Args:
            source: Absolute path of the file/directory to copy.
            destination: Absolute path of the copy destination.

        Returns:
            CopyResult with source and destination paths on success, error on failure.
        """
        raise NotImplementedError("copy not implemented for this backend")
    ...
    def mkdir(self, path: str, parents: bool = True) -> MkdirResult:
        ...
        """
        raise NotImplementedError("mkdir not implemented for this backend")

    async def amkdir(self, path: str, parents: bool = True) -> MkdirResult:
