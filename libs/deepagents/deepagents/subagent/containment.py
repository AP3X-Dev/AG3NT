...
class DistilledReturnContract:
    ...
    def validate_output(self, output: str) -> tuple[bool, list[str]]:
        ...
        if estimated_tokens > self.max_output_tokens:
            violations.append(f"Output too long: ~{estimated_tokens} tokens > {self.max_output_tokens} limit")
...
class SubagentConfig:
    ...
    return_contract: DistilledReturnContract = field(default_factory=DistilledReturnContract)
...
class ContainedSubAgentMiddleware(AgentMiddleware):
    ...
    def __init__(
        ...
        *,
        ...
        containment_prompt = CONTAINMENT_PROMPT.format(max_tokens=self.config.return_contract.max_output_tokens)
